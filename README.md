...
```javascript
snanmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanmeanwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-snanmeanwd/tags). For example,

```javascript
snanmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanmeanwd@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var snanmeanwd = require( 'path/to/vendor/umd/stats-base-snanmeanwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanmeanwd@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-snanmeanwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-snanmeanwd

[test-image]: https://github.com/stdlib-js/stats-base-snanmeanwd/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-snanmeanwd/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-snanmeanwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-snanmeanwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-snanmeanwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-snanmeanwd/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-snanmeanwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-snanmeanwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-snanmeanwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-snanmeanwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-snanmeanwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-snanmeanwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-snanmeanwd/main/LICENSE
